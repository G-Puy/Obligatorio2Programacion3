...
namespace MVCvivero.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public ActionResult PrecargarUsuarios()
        {
            return View();
        }
        [HttpPost]
        public ActionResult PrecargarUsuarios(string cargando)
        {
            List<Usuario> usuarios = new List<Usuario>();

            Usuario u1 = new Usuario() {  Email = "u1@gmail.com", Pass = "Uu1234", EsAutenticado = true };
            usuarios.Add(u1);
            Usuario u2 = new Usuario() {  Email = "u2@gmail.com", Pass = "Uu1234", EsAutenticado = true };
            usuarios.Add(u2);
            Usuario u3 = new Usuario() { Email = "u3@gmail.com", Pass = "Uu1234", EsAutenticado = true };
            usuarios.Add(u3);
            foreach (Usuario item in usuarios)
            {
                ManejadorUsu.AltaUsuario(item);
            }
