            ...
            try
            {
                ...
                if (vm.ambiente != "")
                {
                    if (vm.Imagenes != null)
                    {
                        ...
                        vm.Planta.IntercambiarNombresFotosXNomCientifcoYaddSec();
                        vm.Planta.Altura = vm.Altura;
                        ok = ManejadorPlanta.DarDeAltaPlanta(vm.Planta, vm.idTipoIluminacionSeleccionada, vm.idTipoPlantaSeleccionada);
                    }
                }
                if (ok)
                {
